    ...
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24">
      ...
      <div className="mt-12 space-y-9 text-base leading-8 text-foreground/80">
        <section>
          ...
          <p className="mt-3">We scan a fixed group of established aviation publishers once each day, remove duplicates, and rank stories by safety, scale, industry consequences, and lasting significance. Each edition must include multiple publishers.</p>
        </section>
        <section>
